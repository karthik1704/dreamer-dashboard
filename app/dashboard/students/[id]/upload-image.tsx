...
const UploadImage = ({image_url}:{image_url:string}) => {
    const [image, setImage] = useState(image_url ? image_url : "");
    ...
    <div className="mb-4 md:mb-0 md:mr-4 relative w-[150px] h-[150px]">
      <NextImage
        src={isLoading? image : image?.split('/')[1]==="static" ? `${SERVER_API_URL}${image}` : image}
        alt="Profile Preview"
      fill
