...
import { CreateStudent } from "@/types/students";
...
function StudentsAddForm({ batches }: Props) {
  const { register, control, handleSubmit, watch, formState:{isSubmitting, isLoading} } = useForm<CreateStudent>();
