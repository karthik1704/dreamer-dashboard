    ...
    <div className="sm:grid-cols-2">
      <div className="flex flex-col gap-9">
        ...
        <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          ...
          <form action={EditVidoeWithId}>
          <div className="p-6.5">
              <div className="mb-4.5 flex flex-col gap-6">
                <Select name="batch_id" label="Batch" defaultValue={video.batch_id} required>
                  {batches.map((batch) => (
              ...
              <Select name="video_type" label="Video Type" defaultValue={video.video_type} required>
              ...
              <div className="w-full mb-2">
                ...
                <textarea
                  ...
                  defaultValue={video.video_description}
